...
public class QuanLySinhVien extends javax.swing.JFrame {
    ...
    public QuanLySinhVien() {
        ...
        this.bang = (DefaultTableModel) table.getModel();
        ...
        SinhVien sv1 = new SinhVien("PH13411", "Sang", "sang@gmail.com", 987532334, "Nam", "Bac Giang", "NO AVATAR");
        SinhVien sv2 = new SinhVien("PH16531", "huy", "huy@gmail.com", 987536434, "Nữ", "Ha Noi", "NO AVATAR");
        SinhVien sv3 = new SinhVien("PH15431", "phanh", "phanh@gmail.com", 987532334, "Nam", "Ha Noi", "NO AVATAR");
        this.QLSVService.save(sv1);
        this.QLSVService.save(sv2);
        this.QLSVService.save(sv3);
        this.QLSVService.addtable(bang);
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        this.txtma.setText(table.getValueAt(a, 0).toString());
        this.txtten.setText(table.getValueAt(a, 1).toString());
        this.txtemail.setText(table.getValueAt(a, 2).toString());
        this.txtsdt.setText(table.getValueAt(a, 3).toString());
        if (table.getValueAt(a, 4).equals("Nam")) {
            this.ranam.setSelected(true);
        } else {
            this.ranu.setSelected(true);
        }
        this.txtdiachi.setText(table.getValueAt(a, 5).toString());
...
//        }
    ...
    private void lblhinhanhMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblhinhanhMouseClicked
        ...
        if (re == JFileChooser.APPROVE_OPTION) {
            ...
            this.strhinhanh = f.getName();
            String file = f.getAbsolutePath();
            Icon i = new ImageIcon(file);
            this.lblhinhanh.setIcon(i);
        }
//        try {
