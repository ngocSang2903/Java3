...
public class QuanLyDiemSinhVien extends javax.swing.JFrame {
    ...
    private void addtable() {
        ...
        this.QuanLyDiemSVService.getlist();
        bang.setRowCount(0);
        for (SinhVienDiem svd : QuanLyDiemSVService.getlist()) {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(txtdiemtb, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(45, 45, 45))))
        );
    ...
    private void butsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butsearchActionPerformed
        ...
        if (txtsearch.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Mời bạn mã sinh viên cần tìm.");
            return;
        }
        try {
            SinhVienDiem svd = this.Timkiem();
            if (svd == null) {
                SinhVienDiem sinhVienDiem = this.QuanLyDiemSVService.findma(txtsearch.getText());
                this.lblten.setText(sinhVienDiem.getTenSV());
                this.txtMaSV.setText(sinhVienDiem.getMaSV());
    ...
    private SinhVienDiem Timkiem() {
        ArrayList<SinhVienDiem> Timsv = QuanLyDiemSVService.getlist();
        for (SinhVienDiem svd : Timsv) {
            if (svd.getMaSV().equalsIgnoreCase(this.txtsearch.getText())) {
                index = Timsv.indexOf(svd);
                display();
                break;
            }
        }
